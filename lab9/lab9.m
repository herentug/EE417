...
for i = 1:19
    MA(i*3-2:i*3,i) = [0 -x2(3,i) x2(2,i) ; x2(3,i) 0 -x2(1,i) ; -x2(2,i) x2(1,i) 0]*R*x1(:,i);
    MA(i*3-2:i*3,20) = [0 -x2(3,i) x2(2,i) ; x2(3,i) 0 -x2(1,i) ; -x2(2,i) x2(1,i) 0]*T;
end

[Uest, Sest ,Vest] = svd(MA'*MA);
lambda = Vest(:,end);
...
subplot(1,2,1)
plot3(P_W(1,:),P_W(2,:),P_W(3,:),'b.','MarkerSize',10)
